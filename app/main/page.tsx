...
const HomePage = () => {
  ...
  return (
    <div>
      <Header />
      {/* Hero Section */}
      <section className="bg-gray-900 text-white py-16 px-8 md:px-20 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="mt-12 md:mt-0 md:ml-16">
          {/* Add a hero illustration image or SVG here if needed */}
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8">
            ...
            <div className="relative bg-gray-500 text-gray-900 p-6 rounded-lg shadow-lg w-full lg:w-[500px] text-left">
              <div className="mb-4">
                <Image src="/customer-video.png" alt="Customer" width={450} height={250} className="rounded" />
              </div>
              ...
              <a href="#" className="text-blue-600 text-sm mt-2 inline-block">Watch the video →</a>
            </div>
          </div>

          {/* Logos */}
          <div className="mt-10 flex flex-wrap justify-center items-center gap-6 opacity-80">
            {['squarespace', 'newrelic', 'reddit', 'twilio', 'coinbase', 'shopify'].map((logo) => (
              <Image key={logo} src={`/logos/${logo}.svg`} alt={logo} width={100} height={40} />
            ))}
          </div>
        </div>
      </div>
