...
export default function Page() {
  return (
    <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
      {/* Hero */}
      <Reveal>
        <section className="min-h-screen flex items-start justify-center relative pt-14 md:pt-24">
      ...
      {/* Trusted logos / gradient strip placed between hero and intro */}
      <div className="w-full mt-8 px-4 md:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="rounded-2xl p-8 bg-gradient-to-r from-brand-gradientFrom to-brand-gradientTo text-white">
            <p className="type-body-lg text-center">“Trusted by teams who care about performance.”</p>
            <div className="mt-4 flex justify-center flex-wrap gap-6 opacity-95" aria-label="Trusted logos">
